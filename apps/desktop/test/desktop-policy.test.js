...
import { installBrowserHost } from '../src/main/browser-host.js';
import { createAttentionService } from '../src/main/attention-service.js';
import { projectAX } from '../src/main/ax-projection.js';
const log = { info() {}, warn() {} };
